...
SECRET_KEY = 'django-insecure-8ii=pblhj^l+&svxcj7f)7l$tbo^%uumrk%f!4z$o12v(!sp-u'
...
ALLOWED_HOSTS = [
    'https://cb-production.up.railway.app/',
    'http://cb-production.up.railway.app/',
    'cb-production.up.railway.app',
